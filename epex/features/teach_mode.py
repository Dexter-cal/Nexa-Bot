...
from epex.features.screen_capture import ScreenCapture
from epex.features.input_monitor import InputMonitor
from epex.features.playback_engine import PlaybackEngine
...
class TeachMode:
    ...
    def __init__(self):
        ...
        self.workflows_dir = Path.home() / '.epex' / 'workflows'
